...
RUN apk add \
      ca-certificates
WORKDIR /tmp/haproxy
ADD --checksum=sha256:89b1fe73d54d5990f74997da837f5fd0da1627a1baa62b26f5d358a6f3c48295 https://www.haproxy.org/download/3.3/src/haproxy-3.3.8.tar.gz /tmp/haproxy.tar.gz
